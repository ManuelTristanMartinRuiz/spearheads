...
#Ej.10
barras_material_conservacion <- barplot(table(spear$Conservacion, spear$Materiales), beside = TRUE, legend = TRUE, main = "Conservación por Material", xlab = "Conservación", col = c("lightblue", "blue"), names.arg = c("Excelente", "Bueno", "Regular", "Malo"))
